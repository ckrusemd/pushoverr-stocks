...
pushover_daily = paste(list(msg_worst_sma,msg_worst_rsi,msg_worst_macd,msg_worst_days_since_this_value,msg_best_exp,msg_best_lm,best_turnaround,bestbuy_rsi,bestbuy_pci),collapse="\n")
